        ...
        <header style={{ background: "#17171A", borderBottom: "1px solid #2A2A2F" }}>
          <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px] font-medium tracking-wider" style={{ color: "#75726C" }}>V1</span>
            </div>
    ...
    <div className="min-h-screen w-full" style={{ background: "#0B0B0C", color: "#F2F0EA", fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{ background: "#17171A", borderBottom: "1px solid #2A2A2F" }}>
        <div className="max-w-6xl mx-auto px-6 py-6 relative flex flex-col items-center gap-5">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-semibold tracking-tight" style={{ color: "#F2F0EA", fontFamily: "'Fraunces', serif" }}>RAVUNO</span>
            <span className="text-[10px] font-medium tracking-wider" style={{ color: "#75726C", fontFamily: "'IBM Plex Mono', monospace" }}>V1</span>
          </div>
        ...
        <main className="max-w-6xl mx-auto px-6 py-8">
          ...
          {tab === "crosslist" && (
            <div className="grid lg:grid-cols-[380px_1fr] gap-8">
              <section>
                <div className="rounded-xl border p-6" style={{ background: "#17171A", borderColor: "#2A2A2F" }}>
                  <h2 className="text-lg font-semibold mb-4" style={{ color: "#F2F0EA", fontFamily: "'Fraunces', serif" }}>Add a product</h2>
                ...
                {items.length > 0 && (
                  <div className="mt-6">
                    <p className="text-xs tracking-[0.2em] uppercase mb-2" style={{ color: "#8C8A85", fontFamily: "'IBM Plex Mono', monospace" }}>Saved</p>
                    <div className="space-y-2">
                      {items.map((l) => (
              ...
              <section>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {PLATFORMS.map((p) => (
                    <div key={p.id} className="rounded-xl border overflow-hidden bg-white" style={{ borderColor: "#2A2A2F" }}>
                    ...
                    {cartLines.map((l) => (
                      <div key={l.id} className="pb-3 border-b" style={{ borderColor: "#232327" }}>
                        ...
                        <div className="grid grid-cols-3 gap-2 items-end">
                          <label className="block">
                            <span className="block text-[10px] mb-1 uppercase tracking-wide" style={{ color: "#75726C" }}>Qty</span>
                            <input type="number" min="1" value={l.qty} onChange={(e) => updateQty(l.id, e.target.value)}
                              className="w-full px-2 py-1.5 rounded-md border text-xs text-center outline-none" style={{ borderColor: "#2A2A2F", fontFamily: "'IBM Plex Mono', monospace" }} />
                          </label>
                          <label className="block">
              ...
              {selectedInvoice.lines.map((l, idx) => {
                ...
                return (
                  <div key={idx} className="pb-3 border-b" style={{ borderColor: "#232327" }}>
                    ...
                    <div className="grid grid-cols-4 gap-2 text-xs" style={{ color: "#8C8A85" }}>
                      <div><span className="block text-[10px] uppercase" style={{ color: "#75726C" }}>Qty</span>{l.qty}</div>
