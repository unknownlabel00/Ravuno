...
const CSV_IMPORT_COLUMNS = ["title", "category", "itemType", "brand", "condition", "colour", "remark", "cost", "price", "sku"];
...
const TEMPLATE_TOKENS = ["title", "brand", "category", "condition", "colour", "remark", "price", "sku", "size", "measurements", "chest", "length", "waist", "frontRise", "thigh", "shoulder", "sleeve", "legOpening"];
...
export default function App() {
    ...
    try {
      ...
      if (isEditing) {
        ...
        const editRow = {
          ...
          brand: draft.brand || null, condition: draft.condition || null, colour: draft.colour || null, remark: draft.remark || null,
  ...
  function startEditItem(item) {
    setForm({
      ...
      brand: item.brand || "", condition: item.condition || "", colour: item.colour || "",
  ...
  function downloadSampleImportCsv() {
    const rows = [
      CSV_IMPORT_COLUMNS,
      ["Uniqlo Fleece Jacket", "Apparel", "Jacket", "Uniqlo", "9", "Navy", "small pilling near cuff", "15", "45", "TZ-014"],
        ...
        <header style={{ background: "#17171A", borderBottom: "1px solid #2A2A2F" }}>
          <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px] font-medium tracking-wider" style={{ color: "#75726C" }}>V1.3</span>
            </div>
    ...
    <div className="min-h-screen w-full" style={{ background: "#0B0B0C", color: "#F2F0EA", fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{ background: "#17171A", borderBottom: "1px solid #2A2A2F" }}>
        <div className="max-w-6xl mx-auto px-6 py-6 relative flex flex-col items-center gap-5">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-semibold tracking-tight" style={{ color: "#F2F0EA", fontFamily: "'Fraunces', serif" }}>RAVUNO</span>
            <span className="text-[10px] font-medium tracking-wider" style={{ color: "#75726C", fontFamily: "'IBM Plex Mono', monospace" }}>V1.3</span>
          </div>
